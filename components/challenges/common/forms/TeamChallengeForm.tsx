...
import { teamChallengeSchema, TeamChallengeFormData } from './ChallengeFormProvider';
...
export default function TeamChallengeForm() {
  const { watch } = useFormContext<TeamChallengeFormData>();
  ...
  return (
    <>
      <style jsx>{`
        ...
        .form-section:nth-child(10) { animation-delay: 900ms; }
      `}</style>
