...
// Validation schema cho thử thách đồng đội
...
type CreateTeamChallengeFormData = z.infer<typeof createTeamChallengeSchema>;
...
export default function CreateTeamChallengeModal({ 
  ...
  // Form setup
  const form = useForm<CreateTeamChallengeFormData>({
    resolver: zodResolver(createTeamChallengeSchema),
    defaultValues: {
  ...
  const onSubmit = async (data: CreateTeamChallengeFormData) => {
    try {
      ...
      if (response.data) {
        showToast({
          type: 'success',
          message: 'Tạo thử thách đồng đội thành công!'
        });
      ...
      showToast({
        type: 'error',
        message: 'Có lỗi xảy ra khi tạo thử thách đồng đội'
      });
    }
  };
  ...
  return (
    ...
    >
      <div className="">
        <form id="create-team-challenge-form" onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          {/* Header */}
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-bold flex items-center gap-2">
                    ...
                    Tạo thử thách đồng đội
                  </h2>
                  <p className="text-sm text-base-content/70 mt-1">
                    Thiết lập thử thách đồng đội với các mục tiêu và quy tắc phù hợp
                  </p>
                </div>
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="p-4 space-y-4">
                ...
                <div className="card-body p-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="form-control">
                      ...
                      <input
                        type="text"
                        placeholder="Ví dụ: Thử thách chạy đồng đội 500km trong tháng"
                    ...
                    <div className="form-control">
                      ...
                      <textarea
                        placeholder="Mô tả chi tiết về thử thách đồng đội, mục tiêu và cách tham gia..."
              ...
              {/* 7. Cài đặt thử thách đồng đội */}
              <div className="card bg-base-100 shadow-sm">
                <div className="card-body p-4">
                  <h4 className="font-semibold text-lg mb-3 flex items-center gap-2">
                    <span className="text-lg">👥</span>
                    Cài đặt thử thách đồng đội
                  </h4>
                  <div className="space-y-3">
                    <div className="p-4 bg-base-200 rounded-lg space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="form-control">
                          <label className="label">
                            <span className="label-text">Thành viên tối đa mỗi team</span>
                          </label>
                          <input
                            type="number"
                            min="1"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="form-control">
                          <label className="label">
                            <span className="label-text">Khoảng cách tối thiểu mỗi tracklog (km)</span>
                          </label>
                          <input
                            type="number"
                            min="0"
                        ...
                        <div className="form-control">
                          <label className="label">
                            <span className="label-text">Khoảng cách tối đa mỗi cá nhân (km)</span>
                          </label>
                          <input
                            type="number"
                            min="0"
