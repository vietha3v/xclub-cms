        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              />
              <span className="text-xl font-bold">X-Club</span>
            </div>
            <p className="text-sm">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/training" className="hover:text-primary transition-colors">Huấn luyện</Link></li>
