...
const createEventSchema = z.object({
  ...
  visibility: z.nativeEnum(EventVisibility).default(EventVisibility.CLUB_ONLY),
...
export default function ClubEventForm({ isOpen, clubId, onClose, onSuccess }: ClubEventFormProps) {
  const {
    register,
    handleSubmit,
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="form-control">
                      ...
                      <select className="select select-bordered w-full" {...register('visibility')}>
                        ...
                        <option value={EventVisibility.PRIVATE}>Riêng tư</option>
                        <option value={EventVisibility.INVITE_ONLY}>Chỉ mời</option>
                      </select>
                    </div>
